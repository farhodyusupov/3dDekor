...
<html lang="en">
  <head>
    ...
    <title>B-Hero : Blog Single</title>
    <!-- Favicon -->
			    ...
			    <ul class="navbar-nav mr-auto mu-navbar-nav">
			      ...
			      <li class="nav-item"><a href="portfolio.php">Portfolio</a></li>
			       <li class="nav-item dropdown active">
				        <a class="dropdown-toggle" href="blog.php" role="button" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				          Blog
				        </a>
				       <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				          <a class="dropdown-item" href="blog.php">Blog Archive</a>
								...
								<div class="col-md-8">
									<div class="mu-blog-left">
										...
										<article class="mu-blog-item">
											<img src="assets/images/blog-img-1.jpg" alt="blgo image">
													...
													<div class="col-md-4">
														<article class="mu-blog-item">
															...
															<div class="mu-blog-item-content">
																...
																<a class="mu-blg-readmore-btn" href="blog-single.php">Read more <i class="fa fa-long-arrow-right"></i></a>
															</div>
														</article>
													</div>
													<div class="col-md-4">
													...
													<div class="col-md-4">
														<article class="mu-blog-item">
															...
															<div class="mu-blog-item-content">
																...
																<h1 class="mu-blog-item-title"><a href="#">Seeing the big picture of information and information management</a></h1>
																<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis. </p>
																<a class="mu-blg-readmore-btn" href="blog-single.php">Read more <i class="fa fa-long-arrow-right"></i></a></i></a>
															</div>
														</article>
													</div>
												</div>
						                          ...
						                          <li>
						                            <div class="media">
						                              <div class="media-left">    
						                                <img alt="img" src="assets/images/client.png" class="media-object news-img">
						                              </div>
