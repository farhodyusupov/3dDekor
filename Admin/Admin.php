...
$buyurtma = $db->query("SELECT * FROM gallery ")->fetchAll();
?>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <p class="text-right">
                <button type="button" class="btn btn-info btn-lg" ><a href="new_image.php">Qo'shish</a>
                </button>
            </p>
        </div>
    </div>
                ...
                <div class="navbar-header">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            <li class="active"><a>Rasmlar</a></li>
                            <li ><a href="Hamkorlar.php">Hamkorlar</a></li>
                            <li ><a href="Kategoriya.php">Kategiriyalar</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <table class="table table-bordered" id="mainTable">
                ...
                <tbody>
                <?php foreach ($buyurtma as $buyurtmalar): ?>
                    <tr>
                        <td><?php echo $buyurtmalar["id"] ?></td>
                        <td><?php echo $buyurtmalar["name"] ?></td>
                        <td><?php echo $buyurtmalar["image"] ?></td>
                        <td><?php echo $buyurtmalar["content"] ?></td>
                        ...
                        <td>
                            <a class="btn btn-success" style="font-size: 10px;"
                               href="edit_image.php?id=<?= $buyurtmalar['id'] ?>">Yangilash </a>
                            <a href="del_image.php?id=<?= $buyurtmalar['id'] ?>" class="btn btn-danger"
